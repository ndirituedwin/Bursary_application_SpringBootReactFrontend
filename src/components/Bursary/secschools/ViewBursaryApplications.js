...
import { awardbursaryrequest, awardbursaryrequestasindividual, bursaryapplications, bursaryapplicationsbyapplicationyearandmonth, fetchallapplicationperiodsyears, fetchallapplicationperiodyearmonths, fetchbursaryapplicationsbyschool, fetchbursaryapplicationsbyschoolcategory, fetchschoolcategories, fetchsecschools, updatestudentisapprovedstatus } from '../../../constants/ApiUtils';

export default function ViewBursaryApplications(){
  ...
  const [bursaryawardamount, setbursaryawardamount] = useState([])
    ...
    const fetchbursaryapplications=async ()=>{
        try {
          const response = await bursaryapplications()
          if (response) {
      ...
      const fetcbursaryapplicationsbyapplicationyearandmonth=async (data)=>{
        ...
        try {
          const resp = await bursaryapplicationsbyapplicationyearandmonth(data);
          if (resp) {
        ...
        const fetchapplicationsbyschoolcategory=(event)=>{
            ...
            fetchbursaryapplicationsbyschoolcategory(data.categoryId).then(resp=>{
               setviewbursaryapplications(resp)
               setloading(false)
          }).catch(error=>{
              setloading(false)
        ...
        const fetchapplicationsbyschool=(selectedOption)=>{
            ...
            fetchbursaryapplicationsbyschool(data.schoolId).then((response)=>{
              if(response){
                  setviewbursaryapplications(response)
                  setloading(false)  
      ...
      const handleaward=(e)=>{
        e.preventDefault();
        // const amounttoawardarray=Object.keys(bursaryawardamount);
        // const amounttoawardarray=Object.values(bursaryawardamount);
        ...
        // console.log("awardasindivi",awardbyindividualamount);
        // console.log("awardasindivilist",list);
        ...
        //  return;
           ...
           if(!awardbyindividualamount.length){
            if(globalawardamount.globalamount !==''){
              ...
              // selecteddata.pop('admissionnumber')
               
              console.log("admiss",selecteddata)
                 const data={
                 ...
                 if(data.awardrequest.length==0 || data.amount===null || data.amount===''){
                  ...
                  awardbursaryrequest(data).then((resp)=>{
                    if(resp){
           ...
           awardbursaryrequestasindividual(list).then((resp)=>{
             if(resp){
               console.log("resp",resp)
               setbursaryawardresponse(resp)
              }
     ...
     if(issecondaryschoolsloading){
        ...
        if(secondaryschools?.content?.length>0){
            /*secschools=secondaryschools?.content?.map((school,idx)=>{
 ...
 // console.log("viewbursaryapplicationviewbursaryapplication ",viewbursaryapplications)
      //  viewalapplications=viewbursaryapplications?.content?.map((appl,idx)=>{
          ...
          <section className="content" >
            ...
            <div className="card" style={{ width:"100%" ,overflowX:"scroll",overflow:"scroll",overflowY:"scroll"}}>
                    ...
                    <div className="col-md-3">
                      ...
                      {/* <select name="secondarySchool" className= 'form-control' onChange={(event)=>fetchapplicationsbyschool(event)} width="auto" >
                    ...
                    <div className="card-body" >
                      ...
                      style={{width:"20px",height:"20px" }}
                    />
                        {/* <input type="checkbox" class="select_all_items" style={{width:"20px",height:"20px" }} /> */}
