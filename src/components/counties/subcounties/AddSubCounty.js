...
import { fetchallcountiess, savesubcounty } from '../../../constants/ApiUtils'
// import* as ROUTES from '../../constants/Routes'
import* as ROUTES from '../../../constants/Routes'
import Select from 'react-select'
export default function AddSubCounty() {
                 ...
                 <div className="row">
                   ...
                   <div className="col-md-6">
                       ...
                       <label htmlFor="subcounty" className="control-label">Sub county </label>
                         <input type="text" name="subcounty" onChange={handleInput} value={subcountydata?.subcounty} className={(savesubcountyerror?.subcounty)? 'form-control is-invalid':'form-control'}   placeholder=" sub county" />
